...
export async function runTopicClassifierChain(message: string, contextualItems?: string[]): Promise<TopicClassification> {
  ...
  const systemMessage = contextualItems 
    ? `Given this context: ${JSON.stringify(contextualItems)}
       ...
       - "create-recipe" if they want to create, add, generate, or save a new recipe (e.g., "create a recipe for...", "how do I make...", "I need a recipe for...")
    ...
    : `Determine if the user's query is:
       - "create-recipe" if they want to create, add, generate, or save a new recipe (e.g., "create a recipe for...", "how do I make...", "I need a recipe for...", "show me how to cook...")
